...
# runs your code
srun python ../classificationQ8.py  --experiment "Cased BERT Sweep" --device cuda --model "BERT-base-cased" --batch_size "32" --lr 1e-3 --num_epochs 5 --plot "CASED_BERT_5ep_1e3"
